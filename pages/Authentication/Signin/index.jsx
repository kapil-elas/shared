 ...
 */
 ...
 function Signin({
   ...
   return (
     <PageLayout background="white" sx={{ position: "relative" }}>
       <Grid
         container
               ...
               <SoftBox component="form" role="form">
                 <SoftBox mb={2} lineHeight={1.25}>
                   ...
                   <SoftInput
                     ...
                     required
                     error={initial && !validateEmail(signinDetails?.email)}
                     success={validateEmail(signinDetails?.email)}
                   />
                 </SoftBox>
                 <SoftBox mb={2} lineHeight={1.25}>
                   <SoftBox mb={1} ml={0.5}>
                   ...
                   <SoftInput
                     ...
                     onChange={handleInput}
                     required
                     error={initial && !signinDetails?.password}
                     success={signinDetails?.password}
                   />
                 </SoftBox>
                 <SoftBox mt={4} mb={1}>
                   <SoftButton
                     ...
                     color="info"
                     fullWidth
                     disabled={!signinDetails?.password || !validateEmail(signinDetails?.email)}
                   >
                     sign in
                   </SoftButton>
                 </SoftBox>
